...
SECRET_KEY = "django-insecure-+m4#7nf*r)bopd@q&$lu$hgqaad3*112d!$&jl!l1=(7p1dk#p"
...
INSTALLED_APPS = [
    ...
    "pages.apps.PagesConfig",  # Custom app for the hello world page
]
...
# Provider para almacenamiento de imágenes
